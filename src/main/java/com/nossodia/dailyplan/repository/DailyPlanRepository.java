package com.nossodia.dailyplan.repository;
import com.nossodia.dailyplan.entity.DailyPlan;
import java.time.*;
import java.util.*;
...
public interface DailyPlanRepository extends JpaRepository<DailyPlan, UUID> {
    ...
    @Modifying
    @Query(value = """
        insert into nosso_dia.daily_plans(id, family_id, family_member_id, plan_date, created_at, updated_at)
