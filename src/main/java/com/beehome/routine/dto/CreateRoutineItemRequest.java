...
public record CreateRoutineItemRequest(UUID familyMemberId,
    ...
    public static CreateRoutineItemRequest fromJson(Map<String, Object> values) {
        ...
        return new CreateRoutineItemRequest(JsonFields.uuid(values.get("familyMemberId")), JsonFields.string(values.get("title")), JsonFields.string(values.get("description")), JsonFields.time(values.get("scheduledTime")), JsonFields.integer(values.get("sortOrder")), JsonFields.uuidList(values,"tagIds"));
    }
}
